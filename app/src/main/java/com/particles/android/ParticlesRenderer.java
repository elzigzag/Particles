...
public class ParticlesRenderer implements Renderer {
    ...
    public void onSurfaceCreated(GL10 glUnused, EGLConfig config) {
        ...
        particleProgram.verifyIdForAttibsAndUniforms();
        ...
        texture = TextureHelper.loadTexture(context, R.drawable.particle);
    ...
    public void onDrawFrame(GL10 gl10) {
        ...
        Log.i("onDrawFrame", "currentTime" + currentTime);
